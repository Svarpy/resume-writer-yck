...
from resume_writer.constants import (  # noqa: F401
    APP_VERSION,
    AUTHOR_NAME,
    BODY_SIZE_CHOICES,
    COMPANY_ALIASES,
...
# Re-export render API for existing imports / tests.
from resume_writer.render.api import build_resume  # noqa: F401
from resume_writer.render.docx_ops import (  # noqa: F401
    add_border_rule,
    add_bullet,
    add_education_entry,
...
from resume_writer.render.heuristic import (  # noqa: F401
    _build_resume_heuristic,
    _populate_resume_body_for_template,
)
